                                ...
                                <div className="col-md-9 d-flex justify-content-between">
                                    <div>
                                        ...
                                        >
                                            ...
                                            >
                                                <span style={{ color: "#fff", marginTop: "3px" }}>{product?.rating}</span>
                                            ...
                                            <div style={{ marginLeft: "10px", fontSize: "18px" }}>({product.stock})</div>
                                            <div>
                                                <img src={flipLogo} alt="" height="25px" style={{ paddingLeft: "5px" }} />
                                            </div>
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <ReactTooltip id="delete-tooltip" place="top" content="Remove from Wishlist" />
                                    </div>
