          ...
          <div className="col-sm-12">
            <div className="about">
              ...
              <p>
                ...
                dignissimos! Culpa deleniti magni quasi provident quod.
                Cupiditate asperiores quisquam est repellat molestiae tenetur
                voluptas qui repudiandae rerum veniam, error adipisci?{" "}
              </p>
            </div>
          </div>
          ...
          <div className="col-md-3 col-sm-6">
            <div className="footer-info-single">
              ...
              <p>
                ...
                sed suscipit accusantium cupiditate maiores totam impedit natus
                blanditiis! Quo voluptatibus tempore fugiat error illo cum,
                cumque molestias inventore vitae atque.
              </p>
            </div>
          </div>
        </div>
