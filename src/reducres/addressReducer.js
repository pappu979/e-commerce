...
if(initialState.currentUser) {
    ...
    initialState.addresses = JSON.parse(localStorage.getItem(userAddressKey)) || [];
};
    ...
    reducers: {
        setCurrentUser: (state, action) => {
          ...
          if (action.payload) {
            ...
            state.addresses = JSON.parse(localStorage.getItem(userAddressKey)) || [];
          } else {
            state.addresses = [];
          }
        },
...
export const { setCurrentUser, addAddress, editAddress, removeAddress, clearAddresses } = addressSlice.actions;
